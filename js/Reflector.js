...
THREE.Reflector = function (geometry, options) {
    ...
    var material = new THREE.ShaderMaterial({
        uniforms: uniforms_in,
        vertexShader: shader_water.vert,
        fragmentShader: shader_water.frag,
    });
    ...
    this.setColors = function (skyColor, waterColor)
    {
        this.material.uniforms.skyColor.value = skyColor;
